<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/main.Master" AutoEventWireup="true" CodeBehind="addProduct.aspx.cs" Inherits="projectPSD.Views.addProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
  ...
  <div class="col-lg-8">
      ...
      <div class="d-flex justify-content-end">
          <asp:LinkButton ID="AddProductBtn" runat="server" CssClass="btn btn-primary" OnClick="AddProductBtn_Click">Add New Product</asp:LinkButton>
      </div>
  </div>
</div>
